...
{
	[SerializeField] LocalizedString _dialogueLine = default;
	[SerializeField] ActorSO _actor = default;

	[SerializeField] bool _pauseWhenClipEnds = default; //This won't work if the clip ends on the very last frame of the Timeline
