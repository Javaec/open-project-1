...
{
	[Header("Data")] [SerializeField] ActorSO _actor = default;
	[SerializeField] DialogueDataSO _defaultDialogue = default;
	...
	[SerializeField]
	DialogueActorChannelSO _interactionEvent = default;

	//[SerializeField] private DialogueActorChannelSO _PlayDefaultEvent = default;
	[SerializeField] VoidEventChannelSO _winDialogueEvent = default;

	[SerializeField] VoidEventChannelSO _loseDialogueEvent = default;
	...
	[SerializeField]
	DialogueDataChannelSO _startDialogueEvent = default;
